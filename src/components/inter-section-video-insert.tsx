...
export function InterSectionVideoInsert() {
  return (
    <section className="relative bg-[#0B0D0A] py-16 text-white border-b border-white/10 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-black h-80 sm:h-96 flex items-center justify-center shadow-2xl">
          ...
          <div className="relative z-10 text-center max-w-2xl px-6 space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full border border-brand/30 bg-black/60 backdrop-blur-md px-4 py-1.5 text-xs font-black uppercase tracking-[0.25em] text-brand mx-auto">
